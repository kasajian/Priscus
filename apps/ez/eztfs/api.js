...
var api = {
    ...
    // });
    tfsGetChangeset: {urlPathTpl:'{urlBasePath}/_apis/tfvc/changesets/{id}'},
    ...
    //     console.dir(JSON.parse(data.body));
    // });
    tfsGetWorkItem: {urlPathTpl:'{urlBasePath}/_apis/wit/WorkItems'},
    ...
    //     console.dir(JSON.parse(data.body));
    // });
    tfsGetTestRuns: {urlPathTpl:'{urlBasePath}/{teamPrj}/_apis/test/runs'},
    ...
    //     console.dir(JSON.parse(data.body));
    // });
    tfsGetTestResults: {urlPathTpl:'{urlBasePath}/{teamPrj}/_apis/test/runs/{testRunId}/results', urlQuery:{ 'api-version': '3.0' }},
    ...
    //     console.dir(JSON.parse(data.body));
    // });
    tfsGetBuildDefinitions:  {urlPathTpl:'{urlBasePath}/{teamPrj}/_apis/build/definitions', urlQuery:{ 'api-version': '2.0' }},
    ...
    //     console.dir(JSON.parse(data.body));
    // });
    tfsGetBuilds:  {urlPathTpl:'{urlBasePath}/{teamPrj}/_apis/build/builds', urlQuery:{ 'api-version': '2.0' }},
    ...
    //     console.dir(JSON.parse(data.body));
    // });
    tfsGetTeamProjects:  {urlPathTpl:'{urlBasePath}/_apis/projects'},
    ...
    //     console.dir(JSON.parse(data.body));
    // });
    tfsGetTeams:  {urlPathTpl:'{urlBasePath}/_apis/projects/{projectId}/teams', urlQuery:{ 'api-version': '3.0' }},
